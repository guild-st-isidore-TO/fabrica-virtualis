...
1. On TabAeth front-end, user selects an available FaVirtu function
1. On the corresponding TabAeth page for that FaVirtu function, user makes changes to app behaviour (configs)
1. On the same page, user selects the relevant files and data (inputs)
1. On the same page, user triggers FaVirtu function
1. TabAeth back-end sends user's configs and input data to FaVirtu module's web server
...
1. TabAeth back-end parses data from FaVirtu module
1. TabAeth front-end shows valid result, or error message
